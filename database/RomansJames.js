var RomansJames = {
			...
			chapters: [
				...
				},
				{
					sections: [
						...
						{
							title: "Doxology",
							verses: ["Oh, the depth of the riches of the wisdom and[i] knowledge of God! How unsearchable his judgments, and his paths beyond tracing out! ", "“Who has known the mind of the Lord? Or who has been his counselor?”[j] ", "“Who has ever given to God, that God should repay them?”[k] ", "For from him and through him and for him are all things. To him be the glory forever! Amen. "],
							pronounClarification: [
								[
									{
										pronoun: "his",
			...
			chapters: [
				{
					sections: [
						{
							title: "(Untitled Section)",
							verses: ["James, a servant of God and of the Lord Jesus Christ, To the twelve tribes scattered among the nations: Greetings. "],
							pronounClarification: [[]],
						},
						{
	...
	memoryVerses: {
		...
		multiples: ["R 1:16-17", "R 3:10-11", "R 3:23-24", "R 4:7-8", "R 5:1-2", "R 5:3-4", "R 5:6-7", "R 5:9-10", "R 5:18-19", "R 6:1-2", "R 6:11-12", "R 7:9-10", "R 7:24-25", "R 8:1-2", "R 8:3-4", "R 8:24-25", "R 8:38-39", "R 10:9-10", "R 10:11-13", "R 11:30-32", "R 12:4-5", "R 12:9-10", "R 12:11-13", "R 12:17-18", "R 14:7-8", "R 15:5-6", "J 1:2-3", "J 2:8-9", "J 3:9-10", "J 4:7-8", "J 5:13-14", "J 5:19-20"],
	},
	prejumps: {
		singles: [
			"For since",
		...
		multiples: ["For I am not", "As it", "for all", '"Blessed', "Therefore, since", "Not", "You", "Since", "Consequently,", "What shall", "In", "Once", "What a", "Therefore, there", "For what", "For in", "For I am convinced", "If you declare", "As Scripture", "Just", "For just", "Love", "Never", "Do", "For none", "May", "Consider", "If you really", "With", "Submit", "Is", "My"],
	},
};
